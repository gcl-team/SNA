...
internal static class SimpleServerAndGenerator
{
    public static void RunDemo(ILoggerFactory loggerFactory, double meanArrivalSeconds) 
    {
        ...
        programLogger.LogInformation($"Server Utilization: {simpleSystem.ServicePointObserver.Utilization:P2}, Loads: {simpleSystem.ServicePointObserver.LoadsCompleted}");
